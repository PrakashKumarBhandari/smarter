...
<div id="fullpage" class="znt-index">
            ...
            <div class="container-fluid">
                <div class="heading-contents">
                    ...
                    <div class="heading-paragraph wow fadeInUp">
                        <p>These dummy text Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae consequatur possimus repellat mollitia illo alias nobis consectetur dolorum, iure animi error.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section fullcover" id="section1" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/images/others/image2.jpg">
