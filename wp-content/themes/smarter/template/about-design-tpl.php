...
<div id="fullpage" class="znt-index">
            ...
            <div class="container-fluid">
                <div class="heading-contents">
                    ...
                    <div class="heading-paragraph wow fadeInUp">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae consequatur possimus repellat mollitia illo alias nobis consectetur dolorum, iure animi error.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overall-section">
            <div class="container-fluid">
                <div class="section-subTitle  wow fadeInDown">
                    <h1 class="text-center">Overall</h1>
                </div>
                            ...
                            <div class="overall-card">
                                ...
                                <div class="accodion-contents">
                                    ...
                                    <ul class="accordion">
                                        <li>
                                            <a>Cost</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit, ipsum, fuga, in, obcaecati magni ullam nobis voluptas fugiat tenetur voluptatum quas tempora maxime.</p>
                                        </li>
                                        <li>
                                            <a>Does my Solar panels products in case of a power outage?</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit, ipsum, fuga, in, obcaecati magni ullam nobis voluptas fugiat tenetur voluptatum quas tempora maxime.</p>
                                        </li>
                                        <li>
                                            <a>Whole house Backup battery include?</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit, ipsum, fuga, in, obcaecati magni ullam nobis voluptas fugiat tenetur voluptatum quas tempora maxime.</p>
                                        </li>
                                        <li>
                                            <a>Power Outage Protection</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit, ipsum, fuga, in, obcaecati magni ullam nobis voluptas fugiat tenetur voluptatum quas tempora maxime.</p>
                                        </li>
                                    </ul> <!-- / accordion -->
                                </div>
    ...
    <section class="section" id="section2" style="background-image: linear-gradient(0deg, rgba(0,0,0,0.8631827731092436) 0%, rgba(40,40,40,0.11528361344537819) 25%) ,url(<?php echo get_template_directory_uri();?>/assets/images/banner/heading/banner2.jpg">
        <div class="overall-section">
            <div class="container-fluid">
                <div class="section-subTitle wow fadeInDown">
            ...
            <div class="container-fluid">
                <div class="section-title wow fadeInDown">
                    <div class="main-title text-center">
                        <h2><span class="mg-l">Friquently </span>Asked<span class="mg-l">Questions</span></h2>
                    </div>
                            ...
                            <div class="overall-card">
                                <div class="accodion-contents">
                                    ...
                                    <ul class="accordion ag-accordion minus-icon">
                                        <li>
                                            <a>What kind of solar batteries we use?</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit, ipsum, fuga, in, obcaecati magni ullam nobis voluptas fugiat tenetur voluptatum quas tempora maxime.</p>
                                        </li>
                                        <li>
                                            <a>Does my Solar panels products in case of a power outage?</a>
